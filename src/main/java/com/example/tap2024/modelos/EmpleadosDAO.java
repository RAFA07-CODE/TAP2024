...
public class EmpleadosDAO {
    ...
    public void ACTUALIZAR() {
        String query = "UPDATE empleado ser nomEmpledo='" + nomEmpleado + "'," + "rfcEmpleado='" + rfcEmpleado + "',salario=" + salario + "," + "telefono='" + telefono + "',direccion='" + direccion + "' WHERE idEmpleado = " + idEmpleado;
        try {
            Statement stmt = Conexion.connection.createStatement();
            stmt.executeUpdate(query);
        } catch (Exception e) {
    ...
    public ObservableList<EmpleadosDAO> CONSULTAR() {
        ...
        try {
            ...
            while (res.next()){
                ...
                objEmp.salario = res.getInt("salario");
